                            ...
                            <div class="table-responsive">
                                <form action="tambah-lowongan.php" method="post">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="kode_lowongan" class="form-control" id="kode_lowongan" placeholder="Kode Lowongan" required>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_dibuka" class="form-control" id="tanggal_dibuka" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="tanggal_ditutup">Tanggal Dibuka</label>
                                        <input type="date" name="tanggal_ditutup" class="form-control" id="tanggal_ditutup" required>
                                    </div>
                                    <div>
