...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../page/anggota/daftar-anggota.php">
            ...
            <li class="nav-item">
                <a class="nav-link" href="../page/buku/daftar-buku.php">
            ...
            <!-- Nav Item - Charts -->
            <li class="nav-item">
                <a class="nav-link" href="../page/peminjaman/daftar-peminjaman.php">
